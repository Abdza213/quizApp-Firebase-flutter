...
import 'package:sampleproject/admin/admingetQuizScreen.dart';

class adminbuildquizScreen extends StatefulWidget {
  @override
  State<adminbuildquizScreen> createState() => _adminbuildquizScreenState();
}

class _adminbuildquizScreenState extends State<adminbuildquizScreen> {
  App s1 = Get.find();
  @override
  void initState() {
    s1.getDoc();
